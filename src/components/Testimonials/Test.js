  ...
  const testimonials = [
    {
      ...
      name: "Agency.com",
      message:
        "We have a great business relationship with Agency. We had worked with several other marketing companies in the past who did not deliver results and I am happy to say Agency is doing that for us. They help bring our vision to life in a way that makes sense",
      imgUrl: image.client,
    },
    {
      id: 2,
      name: "Agency.com",
      message:
        "Agency has done a wonderful job redesigning our website to take it from plain and functional to amazingly professional. We would highly recommend WebDev to any business that needs a hand improving their internet traffic or their business.",
      imgUrl: image.client,
    },
    {
      id: 3,
        ...
        <div className="relative left-[5%] right-[5%] h-80">
          ...
          <div className="absolute md:top-12 pr-8">
            ...
            <p className="mt-4 app__text">
              Discover what our clients are saying about our digital marketing
              solutions. Read testimonials from satisfied customers and learn
              how Agency has helped businesses like yours achieve their
              marketing goals.
            </p>
          </div>
        </div>
